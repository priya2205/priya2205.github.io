...
for (let i = 0; i < prev.length; i++) {
  ...
  prev[i].addEventListener("click", (e) => {
    console.log(e.target.parentElement.children[2].children[0].classList[0], "yes") //e.path[1].children[2].children[0].classList[0];;
    let className = e.target.parentElement.children[2].children[0].classList[0]
    offerPressed(className, -1);
  });
  nxt[i].addEventListener("click", (e) => {
    //console.log(e.target.parentElement.children[2].children[0].classList[0],'now')
    console.log(e.target.parentElement.children[2].children[0].classList[0], "yes");
    let className = e.target.parentElement.children[2].children[0].classList[0];
    offerPressed(className, 1);
  });
}
